...
public class guncellemeController {
	...
	public void seciliPersonelMetod(Personel personel) {
	    ...
	    seciliPersonel.getTerfiListesi().add(seciliPersonel.getPozisyon());

	}
	
	@FXML
	public void initialize() {
	    pozisyonChoiceBox.setItems(FXCollections.observableArrayList("Stajyer", "Junior", "Mid Level", "Senior", "Team Lead", "Software Architect", "Freelancer", "CTO"));
